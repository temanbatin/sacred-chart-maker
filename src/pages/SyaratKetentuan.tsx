        ...
        <div className="max-w-4xl mx-auto prose prose-invert">
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              Dengan mengakses dan menggunakan layanan Teman Batin, kamu menyetujui untuk
              terikat oleh syarat dan ketentuan ini. Jika kamu tidak setuju dengan ketentuan
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              ...
              data kelahiran yang kamu berikan. Layanan ini bersifat informatif dan tidak
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              ...
              yang kamu berikan. Kami tidak bertanggung jawab atas ketidakakuratan hasil
          ...
          <section className="mb-8">
            ...
            <p className="text-muted-foreground">
              ...
              berkelanjutan setelah perubahan merupakan penerimaan kamu terhadap ketentuan
              yang diperbarui.
            </p>
          </section>
