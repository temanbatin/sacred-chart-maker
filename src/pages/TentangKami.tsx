      ...
      <main className="pt-24 pb-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-muted-foreground text-center mb-12 max-w-2xl mx-auto">
            Membantu kamu menemukan dan memahami desain sejati diri melalui ilmu Human Design.
          </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-secondary/30 rounded-2xl p-6 border border-border">
              ...
              <p className="text-muted-foreground">
                ...
                dan sistem Chakra untuk mengungkap blueprint energi unik kamu.
              </p>
            </div>
          ...
          <div className="bg-accent/10 rounded-2xl p-8 border border-accent/20 text-center">
            ...
            <p className="text-muted-foreground mb-6">
              Temukan chart Human Design kamu secara gratis dan mulai pahami siapa diri kamu sebenarnya.
            </p>
            <button
